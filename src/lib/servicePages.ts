...
export const LASH_LIFTING_PAGE: ServicePage = {
  ...
  th: {
    ...
    eyebrow: "บริการ",
    quickAnswer:
      "ลิฟติ้งขนตาดัดขนตาจริงให้งอนขึ้นจากโคน อยู่ได้ 6 ถึง 8 สัปดาห์โดยไม่ต้องดูแลรายวัน ไม่มีแฟนสังเคราะห์ ไม่มีรอบเติม ใช้เวลาประมาณ 45 นาที ที่ My Lash House สันกลาง ทุกลิฟต์มีรับประกันรีทัช 3 วันเหมือนเซตต่อขนตา",
    heroImage: "/images/service-wet-look.jpg",
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "น้ำยาลิฟต์: 8 ถึง 12 นาทีที่โคน ไม่แตะปลาย",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "ขนตาสั้นมากหรือเปราะอาจลิฟต์ไม่เด่น ครูหญิงบอกตรง ๆ ตอนปรึกษา ก่อนเริ่มทำอะไรทั้งนั้น",
        ],
      },
      {
        heading: "รับประกันรีทัช 3 วัน ใช้กับลิฟต์ด้วย",
        paragraphs: [
          "ถ้าความโค้งขึ้นไม่สม่ำเสมอ หรือตาข้างหนึ่งลิฟต์น้อยกว่าอีกข้างใน 3 วันแรก ส่งรูปทักมา เราลิฟต์ซ้ำบริเวณนั้นให้ฟรี นโยบายเดียวกับเซตต่อขนตา เพราะมาตรฐานไม่ควรเปลี่ยนตามบริการ",
        ],
      },
    ],
    ...
    faq: [
      {
        ...
        a: "6 ถึง 8 สัปดาห์ ความโค้งจางไปตามการหลุดของขนตาจริงและเส้นใหม่ที่ขึ้นมาตรง ไม่มีการเติมสำหรับลิฟต์ นัดถัดไปคือทำใหม่",
      },
      {
      ...
      },
      {
        ...
        a: "ลิฟต์ถ้าอยากดูแลน้อยและขนตาจริงยาวพอสมควรอยู่แล้ว ต่อถ้าอยากได้วอลุ่ม ความยาว หรือดราม่าที่ขนตาจริงไม่มี ถามตอนปรึกษาแล้วจะได้คำตอบตรง ๆ ไม่ใช่การขายของ",
      },
      {
