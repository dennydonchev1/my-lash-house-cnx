...
ถ้าจะอ่านส่วนเดียว อ่านส่วนนี้ก่อน ตารางด้านล่างจับคู่รูปตา 6 แบบกับข้อมูล 2 อย่าง — ทรงต่อขนตาที่ใช้เป็นจุดเริ่มต้น และแนวเรียงขนตา (mapping) ที่กรอบรูปตานั้นให้สวยที่สุด

![ตารางเปรียบเทียบ: รูปตา 6 แบบ — ตาชั้นเดียว ตาสองชั้น หางตาตก ตากลม หนังตาปิด และตาห่าง — พร้อมทรงต่อขนตาที่แนะนำ (Classic, Hybrid, Light Volume, Wispy Volume, Mega Volume) และแนวเรียงขนตา (Cat Eye, Doll Eye, Kitten Eye) สำหรับแต่ละรูปตา จากคู่มือต่อขนตาของ My Lash House เชียงใหม่](/images/blog/eye-shape-lash-style-comparison-chart.webp)

**วิธีอ่านตาราง:**

- **Recommended Styles (ทรงที่แนะนำ)** — เทคนิคปริมาตร (Classic, Hybrid, Light Volume, Wispy, Russian, Mega) ตัวนี้กำหนดความหนาและความดราม่าของเซต
- **Lash Mappings (แนวเรียงขนตา)** — รูปแบบทิศทาง (Cat Eye, Doll Eye, Kitten Eye, Hybrid) ตัวนี้กำหนดว่าขนตาส่วนยาวสุดจะอยู่ตรงไหน ซึ่งคือสิ่งที่ทำให้รูปตา “เปลี่ยนทรง”

Style คุมว่า *หนาแค่ไหน* Mapping คุมว่า *เป็นทรงอะไร* ลูกค้าส่วนใหญ่คิดถึงแค่ข้อแรกก่อนจอง แต่ข้อสองนี่แหละคือจุดที่ทำให้เซตหนึ่งดูเข้ากับตา ไม่ใช่แค่ขนตายาว ๆ แบบทั่วไป

แต่ละคู่คือจุดเริ่มต้น ครูหญิงจะปรับให้พอดีกับขนตาจริงตอนวันนัดอีกที
